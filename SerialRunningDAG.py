...
def helloworld3():
    print("========= See you soon, from Airflow ================")
...
with DAG('WelcomeToAirflowSerial',
    ...
    hello_task.set_upstream(hello_task4)  # task1 will run after task4
    hello_task2.set_upstream(hello_task)  # task2 will run after task1
    hello_task3.set_upstream(hello_task2)